...
import "./style.css";
import MentorLogo from "./components/logo";
...
const features = [
  {
    ...
    description:
      "Identifica instantáneamente productos con bajo rendimiento y emite alertas específicas sobre las causas del problema.",
  ...
  },
  {
    ...
    description:
      "Genera automáticamente títulos, descripciones y bullets persuasivos para mejorar la conversión.",
  ...
  },
  {
    ...
    description:
      'Crea automáticamente combinaciones de productos (ej. "Kit Fitness") para aumentar el ticket promedio.',
...
export function Mentor() {
  return (
    <section
      id="mentor"
      className="relative py-24 overflow-hidden mentor-container"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-accent-electric/30 mb-6">
            ...
            <span className="text-xs font-mono text-accent-electric uppercase tracking-widest">
              Producto 02
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <motion.div
              key={feature.title}
              className="relative group rounded-xl border border-border/50 bg-card/30 p-8 gentle-animation hover:border-accent-electric/40 hover:elevated-shadow mentor-card"
